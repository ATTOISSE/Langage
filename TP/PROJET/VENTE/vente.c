...
//la fonction gotoxy pour la manipulation du curseur
//qui recoit deux int en parametre

//La fonction gotoxy place le curseur a la position x,y
...
//fonction qui gère la vente  des produits
